...
public class DT2 {
    ...
    public static List getTableInfo(String driver,String url,String user,String pwd,String table){
        ...
        try {
            ...
            ResultSet resultSet = dbmd.getTables("ForeignPayment", "%", table, new String[] { "TABLE" });
    ...
    public static void main(String[] args) {
        ...
        String url = "jdbc:sqlserver://192.168.1.198:1433;DatabaseName=ForeignPayment";
        String user = "sa";
        String pwd = "Time.2017";
        //String table = "FZ_USER_T";
        String table = "[tds].[pay_order]";
